...
%ist das nicht ok so? wir müssen ja nicht 1. 2. 3. machen
...
%-> Ja das ist unsere Produkt, sollen wir es anderst nennen oder bei Turnierbewertungssoftware bleiben?
...
% -> dass es eine online und eine "offline" Lösung gibt, offline = normales turnier
...
%hä warum widerspruch?? Es kann offline (normal) verwendet werden, aber auch online = neu
